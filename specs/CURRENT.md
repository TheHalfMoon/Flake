...
ACTIVE_IMPLEMENTATION_UNIT=T01-01
NEXT_DEPENDENCY_READY_UNIT=T01-01
...
T00-02_MERGE_COMMIT=PENDING_PR_MERGE
T01-01_STATUS=READY_NOT_STARTED
...
`T01-01` — make legacy vault inspection nonmutating and establish writer ownership before mutation, per the corrective Spec Kit at `specs/002-post-r1-canonical-core-convergence/corrective-t01/` and plan section 34.
