...
|---|---|---|
| Windows | Website-first direct distribution (unsigned; project GPG signature + GitHub provenance) | **PASS.** Founder amendment `docs/canonical/FOUNDER_WEBSITE_FIRST_DIRECT_DISTRIBUTION_AMENDMENT_2026-09-26.md` — no Microsoft Store, no paid certificate, no SignPath dependency for v1; `WINDOWS_AUTHENTICODE_TRUST=NOT_AVAILABLE`, `WINDOWS_AUTHENTICODE_TRUST_CLAIMED=NO`, SmartScreen warnings expected and disclosed — real installer + CLI archive built, inspected (`NOT_SIGNED`), GPG-signed, attested, and install-qualified — see `docs/release/WINDOWS_DIRECT_DISTRIBUTION.md` and CI run [36243789672](https://github.com/TheHalfMoon/Pluma/actions/runs/36243789672) |
